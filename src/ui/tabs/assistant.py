...
def create_assistant_tab():
    with gr.Blocks() as tab:
        ...
        gr.Markdown("Ask me how to fix common bicycle issues! My answers are grounded in official maintenance manuals.")
        
        chatbot = gr.Chatbot(height=400, elem_id="rag-chatbot", show_copy_button=True, avatar_images=(None, "https://api.iconify.design/fluent-emoji:robot.svg"))
